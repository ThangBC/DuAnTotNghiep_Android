...
import com.example.datingpolytestn.adapter.ChatAdapter;
import com.example.datingpolytestn.databinding.ActivityChatBinding;
import com.example.datingpolytestn.models.ChatMessage;
import com.example.datingpolytestn.models.User;
import com.example.datingpolytestn.network.ApiClient;
import com.example.datingpolytestn.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage() {
        ...
        if (conversionId != null) {
            ...
            conversion.put(Constants.KEY_SENDER_IMAGE, preferenceManager.getString(Constants.KEY_IAMGE));

            conversion.put(Constants.KEY_RECEIVER_ID, receiverUser.id);
            conversion.put(Constants.KEY_RECEIVER_NAME, receiverUser.name);
            conversion.put(Constants.KEY_RECEIVER_IMAGE, receiverUser.image);

            conversion.put(Constants.KEY_LAST_MASSAGE, binding.inputMessage.getText().toString());
    ...
    private void senNotification(String messageBody) {
